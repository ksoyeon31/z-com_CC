...
// next에서 제공하는 훅 > 근데 useSelectedLayoutSegment는 큰 폴더 애들만 세크먼트로 표시되고(compose/tweet 이렇게 표시 안되고 compose만 표시됨)
// tweet같이 폴더 안에 포함 된 폴더들도 같이 표시되게 하고 싶으면 useSelectedLayoutSegments 를 사용해야함